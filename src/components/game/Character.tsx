...
export function Character() {
  const stats = [
    { label: "FRONTEND", value: 92, color: "var(--hud)" },
    { label: "BACKEND", value: 84, color: "var(--accent)" },
    { label: "DESIGN", value: 88, color: "var(--xp)" },
    { label: "CREATIVITY", value: 96, color: "var(--mp)" },
    { label: "FOCUS", value: 90, color: "var(--hp)" },
  ];
      ...
      <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 w-full max-w-6xl mx-auto items-center">
        ...
        <div>
          ...
          >
            ALEX
            <br />
            <span className="text-accent text-glow-accent">KAIROS</span>
          </motion.h1>
          <motion.div
          ...
          >
            ...
            <span className="font-mono text-xs">CLASS // CREATIVE_ENGINEER · GUILD // OPEN_WEB</span>
          </motion.div>
          <motion.p
            initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
          ...
          >
            I build interactive products that feel alive. Specialist in 3D web,
            generative UI, and motion-first interfaces. Currently grinding the
            endgame: shipping experiences that earn the legendary tag.
          </motion.p>

          <div className="mt-8 flex flex-wrap gap-3">
            {["React", "Three.js", "WebGL", "Motion", "TypeScript"].map((t, i) => (
              <motion.span
                key={t}
        ...
        >
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="font-mono text-[10px] text-muted-foreground">v.2.6.1</span>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-border grid grid-cols-3 gap-3 text-center">
            {[{l:"HP",v:"100",c:"var(--hp)"},{l:"MP",v:"86",c:"var(--mp)"},{l:"STA",v:"94",c:"var(--xp)"}].map((s) => (
              <div key={s.l}>
